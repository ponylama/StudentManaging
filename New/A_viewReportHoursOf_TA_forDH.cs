...
namespace New
{
    public partial class A_viewReportHoursOf_TA_forDH : Form
    {
        public static A_viewReportHoursOf_TA_forDH currentA_viewReportHoursOf_TA_forDH;
        HeadDepartment dep;
        ...
        public A_viewReportHoursOf_TA_forDH(HeadDepartment hd)
        {
            InitializeComponent();
        ...
        private void button_view_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(textBox_deptID.Text))
            {
                ...
                this.Hide();
                //A_viewReportHoursOf_TA_forDH view = new A_viewReportHoursOf_TA_forDH();
                A_viewReportHoursOf_TA_forDH.currentA_viewReportHoursOf_TA_forDH.Show(); 
            ...
            if(deptExist)
            {
                ...
                cmd = new SqlCommand("select ID,name,month,year,hoursAmount FROM staffHours WHERE Type = '3' AND IDdepartment = '" + textBox_deptID.Text +"' AND month = '" + numericUpDown_month.Value + "' AND year = '" + numericUpDown_year.Value + "'", cn);
        ...
        private void A_viewReportHoursOf_TA_forDH_Load(object sender, EventArgs e)
        {
            currentA_viewReportHoursOf_TA_forDH = this;
        }
    }
}
