...
namespace New
{
    public partial class professor_Disciplinarity : Form
    {
        ProfessorClass PC;
        ...
        public professor_Disciplinarity()
        {
            InitializeComponent();
        }
        ...
        public void update()
        {
            ...
            {
                string Query2 = "update Professor_Box set Disciplinarity = '" + Disciplinarity_box.Text + "' WHERE StudentID= '" + Convert.ToInt32(id_list_Box.SelectedItem.ToString()) + "' and CourseID= '" + Convert.ToInt32(cours_List_Box.SelectedItem.ToString()) + "'";
        ...
        private void professor_Disciplinarity_Load(object sender, EventArgs e)
        {
            Show_Courses();
        }

        private void Disciplinarity_box_TextChanged(object sender, EventArgs e)
        {
