...
namespace New
{
    public partial class Button_Yellow : Button
    {
        #region Frame
        ...
        public Button_Yellow()
        {
            InitializeComponent();

            this.DoubleBuffered = true;

            MouseOverFrame = new Frame(Properties.Resources.ButtonMouseOverYellow, 25, 0, new Size(100, 30));
            MouseDownFrame = new Frame(Properties.Resources.ButtonMouseDownYellow, 25, 0, new Size(100, 30));
