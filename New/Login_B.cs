...
namespace New
{
    public partial class Login_B : Form
    {
        StudentClass S1;
        Lecturer lec;  // type == 2
        ...
        private void Login_button_Click(object sender, EventArgs e)
        {
            ...
            {
                string command = "select * from Users where ID = '" + ID_Box.Text + "' and Password = '" + Password_box.Text + "'";
        ...
        private void save_id_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            ForgetPassword_B forget = new ForgetPassword_B();
            forget.Show();
        }
        ...
        private void FaceB_Click(object sender, EventArgs e)
        {
            FB_Analyze.FB_Analyze fb = new FB_Analyze.FB_Analyze();
            fb.ShowDialog();
        }
