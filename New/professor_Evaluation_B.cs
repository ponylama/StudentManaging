...
namespace New
{
    public partial class professor_Evaluation_B : Form
    {
        ProfessorClass PC;
        ...
        public void update()
        {
            ...
            {
                string Query2 = "update Professor_Box set Evaluation = '" + Evaluation.Text + "' WHERE StudentID= '" + Convert.ToInt32(id_list_Box.SelectedItem.ToString()) + "' and CourseID= '" + Convert.ToInt32(cours_List_Box.SelectedItem.ToString()) + "'";
        ...
        private void professor_Evaluation_B_Load(object sender, EventArgs e)
        {
            Show_Courses();
        }
